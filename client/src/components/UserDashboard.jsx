  ...
  return (
    <main className="relative flex-1 p-6 pt-28">
      ...
      <div className="flex flex-col-reverse xl:flex-row">
        {/* left side */}
        <div className="flex flex-[4] flex-col gap-4 lg:gap-7 lg:py-5 justify-between xl:min-h-[85.5vh]">
          <div className="flex flex-col gap-7 flex-[4]">
            <div className="flex flex-row lg:flex-col gap-7 overflow-y-hidden">
              <div className="flex items-center gap-3 bg-white p-5 min-h-[120px] overflow-y-hidden rounded-lg transition hover:shadow-inner duration-300">
                ...
                <span className="bg-gray-300 h-20 lg:min-h-full min-w-20 flex justify-center items-center rounded-lg">
          ...
          <div className="bg-white p-7 text-lg md-text-xl xl:text-2xl 2xl:text-3xl min-h-52 font-semibold relative flex-[3] flex justify-center items-center rounded-2xl">
            <h4 className="overflow-y-hidden">
              "Discover the power of reading — grow, learn, and thrive with easy
        ...
        <div className="flex-[2] flex-col gap-7 lg:flex-row flex lg:items-center xl:flex-col justify-between xl:gap-20 py-5">
          <div className="xl:flex-[4] flex items-center w-full content-center">
            <Pie
              data={data}
              options={{ cutout: 0 }}
              className="mx-auto lg:mx-0 h-full w-full hover:cursor-pointer"
            />
          </div>
          <div className="flex items-center p-8 w-full sm:w-[400px] xl:w-fit mr-5 xl:p-3 2xl:p-6 gap-5 h-fit xl:min-h-[150px] bg-white xl:flex-1 rounded-lg ">
            <img src={logo} alt="logo" className="w-auto h-10 2xl:h-20" />
