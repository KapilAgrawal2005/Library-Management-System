...
export const fetchUserBorrowedBooks = () => async (dispatch) => {
  ...
  await axios
    .get(`${serverUrl}/api/v1/borrow/my-borrowed-books`, {
...
export const fetchAllBorrowedBooks = () => async (dispatch) => {
  ...
  await axios
    .get(`${serverUrl}/api/v1/borrow/borrowed-books-by-users`, {
      withCredentials: true,
    })
    .then((res) => {
      dispatch(
...
export const recordBorrowBook = (email, id) => async (dispatch) => {
  ...
  await axios
    .post(
      `${serverUrl}/api/v1/borrow/record-borrow-book/${id}`,
      { email },
      {
        withCredentials: true,
        headers: {
...
export const returnBook = (email, id) => async (dispatch) => {
  ...
  await axios
    .put(
      `${serverUrl}/api/v1/borrow/return-borrowed-book/${id}`,
      { email },
      {
        withCredentials: true,
        headers: {
