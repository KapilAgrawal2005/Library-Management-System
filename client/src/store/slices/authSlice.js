...
export const register = (data) => async (dispatch) => {
  ...
  await axios
    .post(`${serverUrl}/api/v1/auth/signup`, data, {
...
export const otpVerification = (email, otp) => async (dispatch) => {
  ...
  await axios
    .post(
      `${serverUrl}/api/v1/auth/otp-verification`,
      { email, otp },
      {
        withCredentials: true,
        headers: {
...
export const forgotPassword = (email) => async (dispatch) => {
  ...
  await axios
    .post(
      `${serverUrl}/api/v1/auth/password/forgot`,
      { email },
      {
        withCredentials: true,
        headers: {
...
export const resetPassword = (data, token) => async (dispatch) => {
  ...
  await axios
    .put(`${serverUrl}/api/v1/auth/password/reset/${token}`, data, {
      withCredentials: true,
      headers: {
        "Content-Type": "application/json",
      },
...
export const updatePassword = (data) => async (dispatch) => {
  ...
  await axios
    .put(`${serverUrl}/api/v1/auth/password/update`, data, {
      withCredentials: true,
      headers: {
        "Content-Type": "application/json",
      },
